...
namespace Screenshot_project
{
    ...
    {   
        ...
        private string filename; //Полное имя файла, "path\filename.jpeg"
        ...
        /// <summary>
        /// Метод, очевидно, сохраняет файл в "%TEMP%\filename.jpeg"
        /// </summary>
        private void Save()
        {
        ...
        {
            filename = path.FullName + "\\" + (path.GetFiles().Count() + 1) + ".jpeg";
        }
    }
}
